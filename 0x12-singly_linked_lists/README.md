File 0-print_list.c is a function that prints all the elements of a list_File 1-list_len.c is a a function that returns the number of elements in a linked list_t list.
